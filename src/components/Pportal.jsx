    ...
    <form onSubmit={handleSubmit} className='h-[400px]'>
      <div className="title text-white font-poppins font-bold ">Sign In</div>
        <div className='input-container'>
          <label className='text-white font-poppins text-[20px]'>Patient ID</label>
          <input  
            type="text"
            name='uname'
            placeholder='ID'
  ...
  return (
      <div className='app bg-primary'>
        <div className='login-form '>
            {isSubmitted ?<Link to="/main"><div class="success"><h1 className='text-white font-poppins justigy-content-center py-[10px] font-semibold'>Successfully loged in!</h1><button className='`px-4 py-2 font-poppins font-semibold ss:text-[20px] text-white bg-blue-gradient'>Go to Database</button></div></Link>: renderform} 
        </div>  
      </div>  
  );
};
